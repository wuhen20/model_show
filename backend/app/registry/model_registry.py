...
MODEL_REGISTRY: dict[str, ModelEntry] = {
    ...
    "TQ-01": {
        ...
        "io_type": "timeseries",
        "backend_type": "local",
        "description": "基于CNN+LSTM的台区负荷预测(7天输入→1天输出)与负载率预测(14天输入→3天输出)，支持Optuna超参搜索、两阶段残差修正、96点曲线预测",
        "weight_path": "models_pool/TQ/TQ01/load_forecast_best_model.pt",
        "loader": "torch_cpu",
        "input_spec": [{"field": "curves", "type": "csv", "required": True}],
        "output_spec": [
            {"field": "predictions", "description": "96/288点预测曲线"},
            {"field": "charts", "description": "预测对比图、训练曲线"},
        ],
        "status": "running",
    },
    "TQ-02": {
        ...
        "io_type": "timeseries",
        "backend_type": "local",
        "description": "基于CNN+LSTM的台区功率因数预测(14天输入→3天输出)，支持Optuna超参搜索、96点曲线预测、多台区联合建模",
        "weight_path": "models_pool/TQ/TQ02/pf_best_model.pt",
        "loader": "torch_cpu",
        "input_spec": [{"field": "curves", "type": "csv", "required": True}],
        "output_spec": [
            {"field": "predictions", "description": "288点功率因数预测曲线"},
            {"field": "charts", "description": "预测对比图、训练曲线"},
        ],
        "status": "running",
    },
    "TQ-03": {
        ...
        "io_type": "timeseries",
        "backend_type": "local",
        "description": "基于CNN+LSTM的台区三相不平衡度预测(14天输入→3天输出)，5通道时序输入(功率+功率因数+三相电流)，支持Optuna超参搜索",
        "weight_path": "models_pool/TQ/TQ03/unbalance_best_model.pt",
        "loader": "torch_cpu",
        "input_spec": [{"field": "curves", "type": "csv", "required": True}],
        "output_spec": [
            {"field": "predictions", "description": "288点三相不平衡度预测曲线"},
            {"field": "charts", "description": "预测对比图、训练曲线"},
        ],
        "status": "running",
    },
