...
from app.api.routes.demo_tq_forecast import router as demo_tq_forecast_router
...
app.include_router(demo_tq_forecast_router, prefix="/api/demo/tq-forecast", tags=["台区四精预测演示"])
