...
const stats = computed(() => [
  { label: '可预测文件', value: uploadedFiles.value.length + processedFiles.value.length + mergedFiles.value.length, icon: 'Files', color: '#20a8ff' },
  { label: '可用模型', value: models.value.length, icon: 'Cpu', color: '#34e1ff' },
