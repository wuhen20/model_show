...
const routes = [
  ...
  { path: '/clean-task', name: 'DataCleanTask', component: () => import('@/views/DataCleanTask.vue'), meta: { title: '样本数据清理' } },
  { path: '/clean-task-edit', name: 'DataCleanTaskEdit', component: () => import('@/views/DataCleanTaskEdit.vue'), meta: { title: '清理任务编排' } },
